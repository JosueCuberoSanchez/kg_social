...
class EnrolledEventsContainer extends Component {
    ...
    async componentDidMount () {
        this.props.getEvents(filters.ENROLLED);
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(EnrolledEventsContainer);