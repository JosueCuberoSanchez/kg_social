...
class TopEventsContainer extends Component {
    ...
    async componentDidMount () {
        this.props.getEvents(filters.TOP);
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(TopEventsContainer);